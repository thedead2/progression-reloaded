...
import de.thedead2.progression_reloaded.network.*;
import de.thedead2.progression_reloaded.player.nbt.*;
...
import static de.thedead2.progression_reloaded.ProgressionReloaded.data;
...
public class CriteriaMappings {
    ...
    private void readTriggerData(NBTTagCompound nbt) {
        if (Options.debugMode) de.thedead2.progression_reloaded.ProgressionReloaded.LOGGER.log(Level.INFO, "Reading the nbt data for uuid " + uuid);
    ...
    public void remap() {
        ...
        if (Options.debugMode) de.thedead2.progression_reloaded.ProgressionReloaded.LOGGER.log(Level.INFO, "Progression began remapping for the uuid: " + uuid);
