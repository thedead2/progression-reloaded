...
public class LevelOverlay extends ProgressOverlay<ProgressionLevel> {
    private float previousAlpha;

    private final ProgressBar<ProgressionLevel> progressBar;
    ...
    public LevelOverlay(Area area, LevelDisplayInfo levelDisplayInfo, ProgressBar<ProgressionLevel> levelProgressBar, TextureInfo backgroundFrame, ResourceLocation font) {
        super(area, levelDisplayInfo, backgroundFrame, font);
