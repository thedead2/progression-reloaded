...
public class DrawableTextureSprite implements IDrawableResource {
    ...
    public DrawableTextureSprite(JeiSpriteUploader spriteUploader, ResourceLocation location, int width, int height) {
    ...
    public DrawableTextureSprite trim(int left, int right, int top, int bottom) {
        this.trimLeft = left;
