...
public abstract class RenderObject extends GuiComponent implements Renderable {
    ...
    protected RenderObject(int renderLayer, int width, int height, Area.Position position, Padding padding) {
    ...
    public void setWidth(int width) {
        this.init(width, this.getHeight(), this.position);
    }

    public void setHeight(int height) {
        this.init(this.getWidth(), height, this.position);
    }
    ...
    public void setPadding(Padding padding) {
        this.padding = padding;
        this.init(this.getWidth(), this.getHeight(), this.position);
    }
