...
public class PlayerBredAnimalsTrigger extends SimpleTrigger<Entity>{
    ...
    public static PlayerBredAnimalsTrigger fromJson(JsonElement jsonElement){
        ...
        return new PlayerBredAnimalsTrigger(PlayerPredicate.fromJson(jsonObject.get("player")), EntityPredicate.fromJson(jsonObject.get("parentA")), EntityPredicate.fromJson(jsonObject.get("parentB")), EntityPredicate.fromJson(jsonObject.get("child")));
    }
