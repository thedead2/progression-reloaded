...
public class EntityRestriction extends Restriction<EntityType<?>> {
    ...
    public EntityRestriction(
            ResourceLocation levelId, RestrictionKey<EntityType<?>> key, @Nullable ResourceLocation dimensionId, boolean allowSpawns, int distanceToPlayer, boolean allowSpawners,
    ...
    protected static EntityRestriction fromNetwork(FriendlyByteBuf buf, ResourceLocation levelId, RestrictionKey<EntityType<?>> restrictionKey) {
        ...
        return new EntityRestriction(levelId, restrictionKey, dimensionId, allowSpawns, distanceToPlayer, allowSpawners, entityReplacement);
    }
