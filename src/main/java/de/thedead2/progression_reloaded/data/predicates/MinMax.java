...
public abstract class MinMax<T extends Number> {
    ...
    protected static <T extends Number, R extends MinMax<T>> R fromJson(@Nullable JsonElement pJson, R pDefaultValue, BiFunction<JsonElement, String, T> pValueFactory, MinMax.BoundsFactory<T, R> pBoundedFactory) {
