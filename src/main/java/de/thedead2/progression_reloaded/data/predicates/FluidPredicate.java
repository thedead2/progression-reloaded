...
public class FluidPredicate implements ITriggerPredicate<FluidState>{
    ...
    public static final FluidPredicate ANY = new FluidPredicate(null, null, (StatePropertiesPredicate<FluidState>) StatePropertiesPredicate.ANY);
    @Nullable
