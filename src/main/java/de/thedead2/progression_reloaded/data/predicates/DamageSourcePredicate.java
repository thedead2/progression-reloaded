...
public class DamageSourcePredicate implements ITriggerPredicate<DamageSource> {
    ...
    public static DamageSourcePredicate from(DamageSource damageSource) {
        ...
        return new DamageSourcePredicate(isProjectile, isExplosion, bypassesArmor, bypassesInvulnerability, bypassesMagic, isFire, isMagic, isLightning, directEntity, sourceEntity);
    }
    ...
    public static DamageSourcePredicate fromJson(JsonElement pJson){
        if (pJson != null && !pJson.isJsonNull()) {
            ...
            return new DamageSourcePredicate(isProjectile1, isExplosion1, bypassesArmor1, bypasses_invulnerability, obool4, obool5, obool6, obool7, entitypredicate, entitypredicate1);
        } else {
            return ANY;
        }
    }
