...
public class EntityFlagsPredicate implements ITriggerPredicate<Entity> {
    ...
    public static EntityFlagsPredicate from(Entity entity) {
        ...
        return new EntityFlagsPredicate(entity.isOnFire(), entity.isCrouching(), entity.isSprinting(), entity.isSwimming(), entity instanceof LivingEntity livingEntity ? livingEntity.isBaby() : null);
    }
