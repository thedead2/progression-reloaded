...
public class ItemRestriction extends Restriction<Item> {
    ...
    public ItemRestriction(ResourceLocation levelId) {
        this(levelId, false, false, false, false, false, true);
    }


    public ItemRestriction(ResourceLocation levelId, boolean allowedInInventory, boolean allowedEquipped, boolean allowedAttacking, boolean allowedPickup, boolean allowedUsing, boolean hideInJEI) {
        super(levelId);
    ...
    protected static ItemRestriction fromNetwork(FriendlyByteBuf buf, ResourceLocation levelId) {
        ...
        return new ItemRestriction(levelId, allowedInInventory, allowedEquipped, allowedAttacking, allowedPickup, allowedUsing, hideInJEI);
    }
