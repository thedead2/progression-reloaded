...
public interface IAnimation {
    ...
    static void animateWithKeyframes(TickTimer timer, IAnimationType animationType, IInterpolationType interpolationType, float from, float to, FloatConsumer consumer, Keyframe... keyframes) {
        timer.updateTime();
        float f;
        if(!timer.isStarted()) {
     ...
     * @see IAnimation#animateWithKeyframes(TickTimer, IAnimationType, IInterpolationType, float, float, FloatConsumer, Keyframe...)
     * **/
