...
public class ModItemTabs {
    ...
    public static void registerTab(final CreativeModeTabEvent.Register event){
        PROGRESSION_RELOADED_TAB = event.registerCreativeModeTab(new ResourceLocation(ModHelper.MOD_ID, "progression_reloaded_tab"),
                builder -> builder.icon(() -> new ItemStack(ModItems.PROGRESSION_BOOK.get())).title(Component.translatable(TranslationKeyProvider.translationKeyFor(TranslationKeyType.CREATIVE_MODE_TAB, "progression_reloaded_tab"))));
    }
