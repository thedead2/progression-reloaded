    ...
    public static void init() {
        ...
        for (File file : files) {
            try {
                ...
                if (tab != null) {
                    de.thedead2.progression_reloaded.ProgressionReloaded.LOGGER.log(Level.INFO, "Loaded in the template for the criteria: " + tab.getName());
                    registerTab(tab);
                }
        ...
        for (File file : files) {
            try {
                ...
                if (criteria != null) {
                    de.thedead2.progression_reloaded.ProgressionReloaded.LOGGER.log(Level.INFO, "Loaded in the template for the criteria: " + criteria.getName());
