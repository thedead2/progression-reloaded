...
import de.thedead2.progression_reloaded.api.event.ActionEvent;
...
import de.thedead2.progression_reloaded.helpers.*;
                ...
                if (GuiScreen.isShiftKeyDown()) {
                    ...
                    if (GuiScreen.isCtrlKeyDown()) {
                        for (ICriteria c: requirements.values()) {
                            ...
                            event.getEntityPlayer().openGui(de.thedead2.progression_reloaded.ProgressionReloaded.instance, GuiIDs.EDITOR, event.getEntityPlayer().worldObj, 0, 0, 0);
                            break;
                        }
                    }
                }
