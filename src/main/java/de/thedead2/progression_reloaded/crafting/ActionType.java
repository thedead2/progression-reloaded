...
import de.thedead2.progression_reloaded.api.criteria.IAction;
import de.thedead2.progression_reloaded.api.special.IHasEventBus;
import de.thedead2.progression_reloaded.crafting.actions.ActionBreakBlock;
import de.thedead2.progression_reloaded.crafting.actions.ActionGeneral;
import de.thedead2.progression_reloaded.crafting.actions.ActionHarvestDrop;
import de.thedead2.progression_reloaded.crafting.actions.ActionLivingDrop;
    ...
    public static ActionType getCraftingActionFromIcon(ItemStack stack) {
        ...
        if (type == null) {
            for (ActionType t: registry.values()) {
                if (t.getIcon().getItem() == stack.getItem() && t.getIcon().getDamageValue() == stack.getDamageValue()) {
