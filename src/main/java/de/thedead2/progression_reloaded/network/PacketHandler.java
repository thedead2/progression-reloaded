...
import de.thedead2.progression_reloaded.network.core.PenguinNetwork;
...
public class PacketHandler {
    ...
    public static void registerPacket(Class clazz) {
        ...
        if (Options.debugMode) {
            de.thedead2.progression_reloaded.ProgressionReloaded.LOGGER.log(Level.INFO, "Registered the packet on both sides: " + clazz);
        }
    }
    ...
    public static void registerPacket(Class clazz, Side side) {
        ...
        if (Options.debugMode) {
            de.thedead2.progression_reloaded.ProgressionReloaded.LOGGER.log(Level.INFO, "Registered the packet on " + side + " side: " + clazz);
        }
    }
