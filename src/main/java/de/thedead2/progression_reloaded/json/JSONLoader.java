package de.thedead2.progression_reloaded.json;
...
import de.thedead2.progression_reloaded.progression_reloaded.util.exceptions.CriteriaNotFoundException;
...
import static de.thedead2.progression_reloaded.gui.core.GuiList.TREE_EDITOR;
...
public class JSONLoader {
    ...
    public static DefaultSettings getServerTabData(String hostname) {
        ...
        try {
            ...
            if (!file.exists()) {
                ...
                if (Options.debugMode) de.thedead2.progression_reloaded.ProgressionReloaded.LOGGER.log(Level.INFO, "Writing to the file is being done at getServerTabData(");
    ...
    public static boolean setTabsAndCriteriaFromString(String json, boolean create) {
        try {
            ...
            if (create) {
                if (Options.debugMode) de.thedead2.progression_reloaded.ProgressionReloaded.LOGGER.log(Level.INFO, "Writing to the file is being done at setTabsAndCriteriaFromString");
                //Attempt to write
                File file = FileHelper.getCriteriaFile(serverName, true);
                Writer writer = new OutputStreamWriter(new FileOutputStream(file), "UTF-8");
                writer.write(json);
    ...
    public static void initialiseCriteria(DataCriteria criteria, boolean isClientside) {
        ICriteria theCriteria = APICache.getCache(isClientside).getCriteria(criteria.uuid);
        if (theCriteria == null) {
            de.thedead2.progression_reloaded.ProgressionReloaded.LOGGER.log(org.apache.logging.log4j.Level.WARN, "Criteria was not found, do not report this.");
            throw new CriteriaNotFoundException(criteria.uuid);
        }
    ...
    public static void loadJSON(boolean isClientside, DefaultSettings settings) {
        ...
        if (Options.debugMode) {
            de.thedead2.progression_reloaded.ProgressionReloaded.LOGGER.log(Level.INFO, "Reloaded JSON at " + System.currentTimeMillis() + " " + isClientside);
        }
    ...
    public static void saveJSON(File file, Object toSave, boolean isClient, boolean backups) {
        try {
            if (Options.debugMode) de.thedead2.progression_reloaded.ProgressionReloaded.LOGGER.log(Level.INFO, "Writing to the file is being done at saveJSON");
        ...
        if (Options.debugMode) de.thedead2.progression_reloaded.ProgressionReloaded.LOGGER.log(Level.INFO, "Saved JSON at " + System.currentTimeMillis());
    }
    ...
    public static DataCriteria getDataCriteriaFromCriteria(ICriteria c) {
        ...
        if (Options.debugMode) de.thedead2.progression_reloaded.ProgressionReloaded.LOGGER.log(Level.INFO, "Saved the display name " + c.getLocalisedName());
    ...
    public static void saveData(boolean isClient) {
        if (Options.debugMode) de.thedead2.progression_reloaded.ProgressionReloaded.LOGGER.log(Level.INFO, "Begin logging");
