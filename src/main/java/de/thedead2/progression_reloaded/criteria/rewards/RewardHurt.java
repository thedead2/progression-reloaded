...
public class RewardHurt extends RewardBase implements IInit, ICustomDescription, ICustomWidth, IGetterCallback, IHasFilters, ISpecialFieldProvider {
    ...
    public String getDescription() {
        if (source != null) {
            ...
            return de.thedead2.progression_reloaded.ProgressionReloaded.format(getProvider().getUnlocalisedName() + ".description", TextFormatting.RED + "" + damage + TextFormatting.WHITE, s);
