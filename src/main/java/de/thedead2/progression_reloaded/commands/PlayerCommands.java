...
public class PlayerCommands {
    ...
    public static void register() {
        ModCommand.Builder.newModCommand("players/team", context -> {
            ...
            PlayerData playerData = PlayerDataHandler.getActivePlayer(source.getPlayerOrException());
            if(playerData.isInTeam()) {
                source.sendSuccess(TranslationKeyProvider.chatMessage("player_in_team", ChatFormatting.GREEN, playerData.getTeam().get().getName()), false);
            }
            else {
